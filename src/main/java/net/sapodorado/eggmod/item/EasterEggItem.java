...
public class EasterEggItem extends EggItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
           EasterEggEntity easterEggEntity = new EasterEggEntity(world, user);
           easterEggEntity.setItem(itemStack);
           easterEggEntity.setProperties(user, user.pitch, user.yaw, 0.0F, 1.5F, 1.0F);
           world.spawnEntity(easterEggEntity);
        }
