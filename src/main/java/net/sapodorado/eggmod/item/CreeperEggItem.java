...
public class CreeperEggItem extends EggItem {
    public CreeperEggItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
           CreeperEggEntity creeperEggEntity = new CreeperEggEntity(world, user);
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(new TranslatableText("item.eggmod.creeper_egg_item.tooltip"));
    }
}