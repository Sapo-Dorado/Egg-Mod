...
public class RandomEggEntity extends ThrownItemEntity {
    public RandomEggEntity(EntityType<? extends RandomEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public RandomEggEntity(World world, LivingEntity owner) {
        super(EggMod.RANDOM_EGG_ENTITY, owner, world);
    }

    public RandomEggEntity(World world, double x, double y, double z) {
        super(EggMod.RANDOM_EGG_ENTITY, x, y, z, world);
    }
