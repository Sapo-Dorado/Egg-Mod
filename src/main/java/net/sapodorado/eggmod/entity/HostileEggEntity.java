...
public class HostileEggEntity extends ThrownItemEntity {
    public HostileEggEntity(EntityType<? extends HostileEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public HostileEggEntity(World world, LivingEntity owner) {
        super(EggMod.HOSTILE_EGG_ENTITY, owner, world);
    }

    public HostileEggEntity(World world, double x, double y, double z) {
        super(EggMod.HOSTILE_EGG_ENTITY, x, y, z, world);
    }
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (!this.world.isClient) {
            int idx = random.nextInt(EggModUtils.hostile_entities.length);
            Entity entity = EggModUtils.hostile_entities[idx].create(this.world);
    ...
    protected Item getDefaultItem() {
        return EggMod.HOSTILE_EGG_ITEM;
    }
