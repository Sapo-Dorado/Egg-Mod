...
public class ChargedCreeperEggEntity extends ThrownItemEntity {
    public ChargedCreeperEggEntity(EntityType<? extends ChargedCreeperEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChargedCreeperEggEntity(World world, LivingEntity owner) {
        super(EggMod.CHARGED_CREEPER_EGG_ENTITY, owner, world);
    }

    public ChargedCreeperEggEntity(World world, double x, double y, double z) {
        super(EggMod.CHARGED_CREEPER_EGG_ENTITY, x, y, z, world);
    }
